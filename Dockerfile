...
ARG VITE_CALINO_BROWSER_SESSION_DAV_URL=
ARG VITE_CALINO_BROWSER_SESSION_ACCOUNT_NAME=Calendar
ARG VITE_CALINO_BROWSER_SESSION_DEFAULT_CALENDAR_NAME=Personal
ENV VITE_SITE_URL=$VITE_SITE_URL \
    ...
    VITE_CALINO_BROWSER_SESSION_DAV_URL=$VITE_CALINO_BROWSER_SESSION_DAV_URL \
    VITE_CALINO_BROWSER_SESSION_ACCOUNT_NAME=$VITE_CALINO_BROWSER_SESSION_ACCOUNT_NAME \
    VITE_CALINO_BROWSER_SESSION_DEFAULT_CALENDAR_NAME=$VITE_CALINO_BROWSER_SESSION_DEFAULT_CALENDAR_NAME
